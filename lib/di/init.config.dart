...
import '../src/data/datasources/wather_remote_data_source.dart' as _i7;
import '../src/data/repositories_impl/home_repository_impl.dart' as _i8;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i7.WeatherRemoteDataSource>(
      _i7.WeatherRemoteDataSourceImpl(get<_i6.RemoteService>()));
  gh.singleton<_i4.HomeRepository>(_i8.HomeRepositoryImpl(
      get<_i7.WeatherRemoteDataSource>(), get<_i5.NetworkInfo>()));
  return get;
}
